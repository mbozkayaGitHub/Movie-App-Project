...
const MovieDetail = () => {
  ...
  const API_KEY = "730018ab09151c279391e201b6a0afa6";
    ...
    <div className="md:container px-10 mx-auto py-5">
      ...
      <div className="md:container flex justify-center px-10">
        <div className="flex flex-col lg:flex-row max-w-6xl rounded-lg bg-gray-400 shadow-lg">
          <img
            className=" lg:w-1/3 h-96 lg:h-[600px] object-cover rounded-t-lg md:rounded-none md:rounded-l-lg p-3"
          ...
          <div className="p-6 flex flex-col justify-between" >
            <div>
              ...
              <p className="text-gray-700 text-base mb-4 text-justify">{overview}</p>
            </div>
